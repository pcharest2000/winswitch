    ...
    static struct option long_options[] =
        {
            ...
            {"nosticky", no_argument, 0, 'a'},
            {"fontcolor", required_argument, 0, 'b'},
            {"font", required_argument, 0, 'c'},
            {"boxcolor", required_argument, 0, 'd'},
            {"winalpha", required_argument, 0, 'e'},
            {"timeout", required_argument, 0, 'f'},
            {"help", no_argument, 0, 'g'},
            {"label", required_argument, 0, 'h'},
            {"fontsize", required_argument, 0, 'i'},
            {0, 0, 0, 0}};
